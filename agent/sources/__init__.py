...
# Plan 03-03 inserts LocalSource between Bilibili and Generic (just before sentinel).
...
SOURCES: list[Source] = [
    ...
    BilibiliSource(),
    LocalSource(),    # 03-03: between Bilibili and Generic; LocalSource.match() rejects URLs
